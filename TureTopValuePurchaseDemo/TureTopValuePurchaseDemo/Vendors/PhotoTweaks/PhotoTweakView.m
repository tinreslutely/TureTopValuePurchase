...
- (instancetype)initWithFrame:(CGRect)frame touches:(BOOL)touches
{
...
- (instancetype)initWithFrame:(CGRect)frame image:(UIImage *)image cropSize:(CGSize)cropSize touches:(BOOL)touches
{
    if (self = [super init]) {
        ...
        _cropView = [[CropView alloc] initWithFrame:CGRectMake(0, 0, _cropSize.width, _cropSize.height) touches:touches];
        ...
        [_resetBtn setTitle:NSLocalizedStringFromTable(@"旋转", @"PhotoTweaks", nil) forState:UIControlStateNormal];
